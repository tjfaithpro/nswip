    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
                <router-link to="/user_dashboard/index" class="nav-link">
          ...
          <li class="nav-item"> 
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-firefox-browser"></i><!--fas fa-tachometer-alt-->
              <p>
                 Manage Website
          ...
          <li class="nav-item"> 
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-blog"></i><!--fas fa-tachometer-alt-->
              <p>
                 Blogs
