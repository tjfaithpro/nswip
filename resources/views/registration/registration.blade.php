    ...
    <div class="container">
        <div class="row">
           ...
           <div class="content first-content" style="width:100vw; padding:2%;">
                ...
                {!! Form::open(['action'=>'registrationController@store','method'=>'POST','class'=>'registrationForm']) !!}
                ...
                <div class="form-group-separation"> 
                        ...
                        <hr style="background-color:black; width:6%; float:left"> <br>  
                <div class="form-group">
                    
                        <div class="col-md-12">
                                <br>
                                {!! Form::label('schoolRegName', 'School registration Name') !!}<span style="color:red"> *</span>
                                {!! Form::text('schoolRegName', '', ['class'=>'form-control','placeholder'=>'Enter School registration Name','required']) !!}
                        </div>
                    ...
                    <br><br>    
                     <div class="form-group" style="width:100%; display:inline-flex; flex-wrap:wrap">
                                <div class="col-md-6">
                                                {!! Form::label('schoolRCNo', 'RC No/BN as provided by Ministry If Available') !!}
                                                {!! Form::text('schoolRCNo', '', ['class'=>'form-control']) !!}
                                        </div>
                    ...
                    <div class="form-group" style="width:100%; display:inline-flex; flex-wrap:wrap">
                                <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                {!! Form::text('taxId', '', ['name'=>'taxId','class'=>'form-control']) !!}
                                        </div>
                    </div>
                    <div class="form-group" style="width:100%; display:inline-flex; flex-wrap:wrap">
                                <div class="col-md-6">
                ...
                <div class="form-group" style="text-align:center; margin-top:4%">
                        <div class="col-md-12">
                                {!! Form::submit('Submit Application', ['class'=>'btn btn-danger regBTN','style'=>'width:50%']) !!}
                        </div>
                </div>
